...
:END:
** [?] [[https://hellowisp.atlassian.net/browse/WISPENG-468][WISPENG-468]]: Handle patient accept
...
** [?] [[https://hellowisp.atlassian.net/browse/WISPENG-812][WISPENG-812]]: Replace placeholder text for approve/deny cart flash messages
:LOGBOOK:
...
** [?] [[https://hellowisp.atlassian.net/browse/WISPENG-843][WISPENG-843]]: When a patient accepts a ProposedCart, send the cart through the checkout processor
- Note taken on [2024-10-29 Tue 12:17] \\
  Need to write tests. Everything appears to work.
:LOGBOOK:
CLOCK: [2024-10-29 Tue 20:20]--[2024-10-29 Tue 21:50] =>  1:30
...
** [ ] Ask the data team if the Proposed Cart table is enough to satisfy the requirements in [[https://hellowisp.atlassian.net/browse/WISPENG-472][WISPENG-472]] and [[https://hellowisp.atlassian.net/browse/WISPENG-481][WISPENG-481]].
Ask the devs too.
** [-] Ask the channel if we need to do anything for [[https://hellowisp.atlassian.net/browse/WISPENG-482][WISPENG-482]]: handle patient text response
