...
:END:
** [-] [[https://hellowisp.atlassian.net/browse/WISPENG-603][WISPENG-603]]: Lab slips do not show if the Order is rejected first
:LOGBOOK:
...
** [?] [[https://github.com/hellowisp/secure.hellowisp.com/pull/4753][Add PLR0917 to exceptions list for new test suite]]
